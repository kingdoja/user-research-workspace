...
export default async function UniversalAgentQaPage() {
  ...
  const workspace: AgentWorkspaceData = {
    ...
    recentRuns: [{
      ...
      retryOfRunPublicId: null,
      errorCode: "AGENT_PRODUCT_TOOL_CALL_LIMIT_EXCEEDED",
      errorMessage: "Agent Run 已达到原生产品工具调用上限。",
      ...
      maxCostMicros: 1_000_000,
      externalExecutionAllowed: true,
      retryOfRunPublicId: "agr_qa_original",
      errorCode: null,
      errorMessage: null,
      startedAt: new Date().toISOString(),
    }],
